...
public static class SpriteTools
{
    ...
    public static Vector3 RandomTopOfScreenLocationScreenSpace()
    {
        ...
        if (rand == 0)
        {
            return new Vector3(Screen.width - 240, Screen.height - 720, 10);
        }
        if (rand == 1)
        {
            return new Vector3(Screen.width - 720, Screen.height - 720, 10);
        }
        if (rand == 2)
        {
            return new Vector3(Screen.width - 1200, Screen.height - 720, 10);
        }
        if (rand == 3)
        {
            return new Vector3(Screen.width - 1680, Screen.height - 720, 10);
        }
